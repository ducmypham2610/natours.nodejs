...
exports.showAlert = exports.hidenAlert = void 0;

// type is success or failure
var hidenAlert = function hidenAlert() {
  var el = document.querySelector('.alert');
  if (el) el.parentElement.removeChild(el);
};

exports.hidenAlert = hidenAlert;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LIaO7LQLs9gbN581HlcDbFn0MWXaGWbNgTZBLaZOgM0hv1kiUSZf38T5u6Ii1n0kSp00iPkN03dnBuGn8yRpD7n00imsjVyal');
            _context.prev = 1;
            _context.next = 4;
